        ...
        <div className="flex flex-col items-center mt-8">
          <div className="w-3/5 gradient-background">
            ...
            <div className="m-5 text-center">
              During my studies at CSUMB I studied many areas of Computer
              Science Such as Networking, Operating Systems, Software
              Engineering and Design, Database Management and other areas. This
              is a collection of some of my class assignments, what was learned
              and what was expected as a student.
            </div>
            <div>
